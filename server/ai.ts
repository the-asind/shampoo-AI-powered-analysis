...
Если новый состав уступает лидеру только в сенсорике или «богатстве» хвоста, но при этом чище и без отдушки, не занижай его сильно.
Если новый состав похож на референс по уровню, ставь score в пределах примерно ±3 баллов.
...
Не резервируй 80+ только для сложных или длинных формул. Минималистичный мягкий шампунь без красных флагов может быть в диапазоне 80–85.
Не поднимай оценку только за экстракты, витамины, масла, «детокс», кофеин, кератин или большое количество ингредиентов.
Не учитывай цену, если она не передана явно отдельным полем. Если цена неизвестна, score должен отражать качество состава, а не value.
